...
def main():
    path_file = open("records/sample.txt", 'r')
    ...
    criteria = 10
    predictor = Predictor(criteria, "records/gazebo-1-x.csv", "records/gazebo-1-y.csv", offline_path_x, offline_path)
